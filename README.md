...
This repo contains an backup and restore shell script for ESXi without additional tools like OVF tool or vSphere. It relies only on shell (sh) and vmkfstools, which are available on a bare ESXi host installation.
